...
import { FaCoins, FaStore, FaTrophy } from 'react-icons/fa';
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        <div className="bg-white p-4 rounded-xl shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-600">Reward Threshold</span>
          </div>
          <p className="text-2xl font-bold text-gray-800">{businessInfo.rewardThreshold}</p>
        </div>

        <div className="bg-white p-4 rounded-xl shadow-sm">
          <div className="flex items-center gap-2 mb-2">
            <FaTrophy className="text-amber-500" />
            <span className="text-sm font-semibold text-gray-600">Reward Amount</span>
          </div>
          <p className="text-2xl font-bold text-gray-800">{businessInfo.rewardAmount}</p>
        </div>
      </div>
